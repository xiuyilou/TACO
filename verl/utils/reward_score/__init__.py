...
math_verify_set = set(['lighteval/MATH', 'DigitalLearningGmbH/MATH-lighteval', 'lighteval/MATH-Hard', 'HuggingFaceH4/aime_2024', 
    'HuggingFaceH4/MATH-500', 'math-ai/amc23','yentinglin/aime_2025','open-r1/OpenR1-Math-220k','ScaleFrontierData/olympiadbench','math-ai/minervamath','agentica-org/DeepScaleR-Preview-Dataset','open-r1/DAPO-Math-17k-Processed','Maxwell-Jia/AIME_2024', 'math_dapo'])
def default_compute_score(data_source, solution_str, ground_truth, extra_info=None, sandbox_fusion_url=None, concurrent_semaphore=None, memory_limit_mb=None):
    ...
    elif data_source in math_verify_set:
    ...
    elif data_source == "open-r1/DAPO-Math-17k-Processed" or data_source.startswith("aime"):
        from . import math_dapo
