...
from verl.workers.rollout.vllm_rollout.utils import TensorMetadata, get_colocate_zmq_handle, get_device_uuid
...
class ServerAdapter(BaseRollout):
    ...
    def __init__(
        ...
        self.zmq_handle = get_colocate_zmq_handle(self.device_uuid)
    ...
    def generate_sequences(self, prompts: DataProto) -> DataProto:
        ...
        raise NotImplementedError(
            ...
            "Please ensure the rollout settings and model config are consistent."
        )
