    ...
    def _generate_minibatch(self, prompts: DataProto) -> DataProto:
        ...
        if not do_sample:
            ...
            response_length = prompts.meta_info.get(
                "response_length",
                self.config.val_kwargs.max_new_tokens
                if getattr(self.config.val_kwargs, "max_new_tokens", None) is not None
            ...
            kwargs = {
                ...
                # Keep the prompt length consistent with the trainer-side slicing logic.
