...
class ActorConfig(BaseConfig):
    ...
    entropy_varentropy_chunk_rows: int = 256
    adv_reweight_enable: bool = False
    adv_reweight_alpha: float = 0.1
    beta_varentropy: float = 0.0
    use_shape_credit: bool = False
    shape_topk: int = 20
    ...
    keep_sampling_top_k: int = 0
    keep_sampling_min_p: float = 0.0
    keep_sampling_feasible_set: bool = False
    keep_sampling_feasible_set_t_in: float = 1.0
    keep_sampling_feasible_set_rho: float = 0.0
    stapo_enable: bool = False
    stapo_prob_threshold: float = 0.002
    stapo_entropy_quantile: float = 0.1
    stapo_only_positive_advantage: bool = True
    tampo_mask_enable: bool = False
    tampo_prob_threshold: float = 0.002
    tampo_entropy_threshold: float = 0.5
    support_set_min_p: Optional[float] = None
    # If True (STAPO-style S2T): apply support-set gating only where advantage > 0.
    support_set_only_positive_advantage: bool = True
    support_set_minp_tau: float = 0.2
    support_set_min_weight: float = 0.2
    taco_enable: bool = False
    taco_alpha: float = 0.01
    taco_lambda: float = 0.9
