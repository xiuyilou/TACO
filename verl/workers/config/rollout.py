...
class SamplingConfig(BaseConfig):
    ...
    do_sample: bool = True
    n: int = 1
    max_new_tokens: Optional[int] = None   # ← 加这一行
...
class RolloutConfig(BaseConfig):
    ...
    norm_entropys: Optional[list[float]] = None
    feasible_set: bool = False
    feasible_set_t_in: float = 1.0
    feasible_set_rho: float = 0.0
    feasible_set_entropy_coeff: float = 0.02
    feasible_set_prob_cap: float = 0.005
    feasible_set_fixed_top_k: int = 0
    do_sample: bool = True
    n: int = 1
